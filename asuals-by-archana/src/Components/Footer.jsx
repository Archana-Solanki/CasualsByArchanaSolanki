        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-12 mb-12">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="space-y-3">
              ...
              <a href="/shop" className="block text-gray-400 hover:text-white transition-colors duration-300 text-sm hover:translate-x-1 transform">
                Collections
              </a>
              <a href="/blogs" className="block text-gray-400 hover:text-white transition-colors duration-300 text-sm hover:translate-x-1 transform">
                Blogs
              </a>
              <a href="#contact" className="block text-gray-400 hover:text-white transition-colors duration-300 text-sm hover:translate-x-1 transform">
                Contact
              </a>
            </div>
          </div>
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex space-x-4 mb-6">
              <a href="#" className="w-10 h-10 bg-gray-800 hover:bg-white hover:text-black rounded-full flex items-center justify-center transition-all duration-300 transform hover:scale-110">
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 items-center">
            ...
            <div className="flex flex-wrap gap-6 text-sm">
              ...
              <a href="/exchange" className="text-gray-400 hover:text-white transition-colors duration-300 hover:underline">
                Exchange Policy
              </a>
            </div>
